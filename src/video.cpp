...
namespace video {
  ...
  struct encoder_platform_formats_nvenc: encoder_platform_formats_t {
    encoder_platform_formats_nvenc(
      ...
      encoder_platform_formats_t::static_pix_fmt = static_pix_fmt;
      encoder_platform_formats_t::dynamic_pix_fmt = dynamic_pix_fmt;
    }
  };
...
#undef _CONVERT
  ...
  make_avcodec_encode_session(platf::display_t *disp, const encoder_t &encoder, const config_t &config, int width, int height, std::unique_ptr<platf::avcodec_encode_device_t> encode_device) {
    ...
    auto sw_fmt = colorspace_is_dynamic(colorspace) ? platform_formats->avcodec_dynamic_pix_fmt : platform_formats->avcodec_static_pix_fmt;
  ...
  make_encode_device(platf::display_t &disp, const encoder_t &encoder, const config_t &config) {
    ...
    auto pix_fmt = colorspace_is_dynamic(colorspace) ? encoder.platform_formats->dynamic_pix_fmt : encoder.platform_formats->static_pix_fmt;
